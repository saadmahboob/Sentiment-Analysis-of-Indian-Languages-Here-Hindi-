...
model.fit(data_train,y_train, batch_size=32,epochs=9,validation_data=(data_test, y_test), verbose=1,sample_weight=None, initial_epoch=0,validation_split=0.1)
